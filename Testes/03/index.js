const dados = [
  ...
  console.log(`O menor valor de faturamento ocorrido em um dia do mês é: ${menorValor}`);
  ...
  console.log("Maior faturamento do mês: R$", maiorFaturamento.toFixed(2));
  ...
  // Calcula a soma do faturamento diário e a média mensal
  for (let i = 0; i < dados.length; i++) {
      somaFaturamento += dados[i].valor;
  }
  
  mediaMensal = somaFaturamento / dados.length;
